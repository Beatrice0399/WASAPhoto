...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.DELETE("/users/:uid/photo/:phid", rt.wrap(rt.deletePhoto))
	rt.router.GET("/users/:uid/photos/:phid/", rt.wrap(rt.getPhotoComments))
	...
	rt.router.PUT("/users/:uid/banned/:bid", rt.wrap(rt.banUser))
	rt.router.DELETE("/users/:uid/banned/:bid", rt.wrap(rt.unbanUser))

	rt.router.GET("/users/:uid/stream", rt.wrap(rt.getMyStream))

	rt.router.PUT("/users/:uid/photos/:phid/likes", rt.wrap(rt.likePhoto))
